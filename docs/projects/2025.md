...
<div>
    <table>
        <tr>
            <td>
                Issue <a href="https://github.com/LF-Decentralized-Trust-Mentorships/mentorship-program/issues/39" class=".btn">39</a>
            </td>
            <td>
                <b>
                    Web3j Libraries Full Lifecycle Development Mentorship
                </b>
            </td>
        </tr>
        <tr>
...
- Gain hands-on experience contributing to an open-source blockchain library, improving their understanding of Ethereum integration in JVM applications.
- Develop expertise in Java and its application in blockchain smart contract development.
- Enhance their skills in software libraries architecture, Ethereum blockchain and Solidity Smart Contracts development practices.
- Collaborate with an open-source community, learning best practices for issue tracking, code reviews, and pull request management.
- Develop expertise in complex library release process and code management. 


### Expected Outcome and Deliverables

The successful completion of this project will result in the following:
- Recover the web3j-openapi project with latest java technologies in order to expose smart contracts wrappers deployments throughout swagger APIs.
- Extend web3j-unit to support integration tests for smart contracts wrappers which are importing external contracts libraries.
- Reduce the number of the open issues in the hyperledger-web3j repository by 30-40%.
- Improved documentation with best practices for integrating Ethereum with applications using Web3j with the new features achieved during the mentorship.
- Final project report summarizing enhancements, challenges encountered, and recommendations for future improvements.


### Relation to LF Decentralized Trust and impact on the community

This project will contribute significantly to the LF Decentralized Trust initiative by ensuring that Web3j remains a high-quality and well-maintained library for Ethereum developers. By improving the library and its maintainability, we can foster a more robust, efficient, and developer-friendly ecosystem for building decentralized applications (dApps). The improvements will benefit not only core maintainers but also the broader blockchain community, reducing barriers to entry and enhancing Ethereum adoption.
As mentees collaborate with the maintainer on various tasks throughout the mentorship, they will gain valuable experience and insights. By the end of the program, if they demonstrate proficiency and interest, they may have the opportunity to become a maintainer themselves.


### Recommended Skills

1. Strong Understanding of Java Development: Knowledge of java versions, Intellij Idea, Gradle, Github.
2. Very good understanding of Java and Kotlin.
3. Background in computer science, computer engineering, or equivalent.
4. Experience with Ethereum and Smart Contracts: Understanding of Ethereum blockchain, smart contracts, and how they interact with applications using web3j.
5. Familiarity with web3j Library: A grasp of the existing web3j library functionalities, structures.
6. Problem-Solving Skills: Ability to diagnose and troubleshoot complex issues that may arise during development or integration of blockchain technologies in JVM applications.
...
https://lf-hyperledger.atlassian.net/wiki/spaces/WEB3J/overview
...
https://docs.web3j.io
    ...
    <div class="right-align">
        Created At 2025-03-13 10:28:10 +0000 UTC
    </div>
</div>
...
<div>
    <table>
        <tr>
            <td>
                Issue <a href="https://github.com/LF-Decentralized-Trust-Mentorships/mentorship-program/issues/37" class=".btn">37</a>
            </td>
            <td>
                <b>
...
- Gain hands-on experience contributing to an open-source blockchain library, improving their understanding of Ethereum integration in Android applications.
- Develop expertise in Kotlin and its application in blockchain smart contract development.
- Enhance their skills in mobile-first software libraries architecture, Ethereum blockchain and modern Android and Solidity Smart Contracts development practices.
- Collaborate with an open-source community, learning best practices for issue tracking, code reviews, and pull request management.
- Strengthen their ability to work on blockchain real-world projects, improving problem-solving, debugging, and software optimization skills.
- Develop expertise in complex library release process and code management. 


### Expected Outcome and Deliverables

The successful completion of this project will result in the new capability of web3j-android library to generate Kotlin Smart Wrapper Contracts. This will be covered by the following:
- Implementation of Kotlin-based smart contract wrapper generation for Web3j-Android.
- Improved documentation detailing best practices for integrating Ethereum with Android applications using Web3j.
- Comprehensive test suite and automated testing framework to ensure code stability and reliability.
- New release procedure defined for web3j-android which keeps up to date with the main Web3j release.
- Final project report summarizing enhancements, challenges encountered, and recommendations for future improvements.


### Relation to LF Decentralized Trust and impact on the community

By improving Android support within Web3j, which is part of LF Decentralized Trust, will contribute to fostering a more robust, efficient, and developer-friendly mobile blockchain ecosystem. The enhanced features and documentation will empower Android developers to integrate decentralized applications (dApps) more effectively, reducing the barriers to entry and expanding blockchain adoption across industries.
...
5. Problem-Solving Skills: Ability to diagnose and troubleshoot complex issues that may arise during development or integration of blockchain technologies in Android applications.
6. Version Control with Git: Experience with Git for version control to manage code changes and collaborate with other developers.
7. Communication and Collaboration Skills: Ability to work effectively in a team, articulate ideas clearly, and collaborate on complex projects.
...
https://docs.web3j.io
    ...
    <div class="right-align">
        Created At 2025-03-13 10:13:35 +0000 UTC
    </div>
</div>
